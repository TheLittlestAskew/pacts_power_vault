...
A boss-level **hatred-manifestation** that coalesces in the entryway of [[Maze's End]] from the **corrupted black [[Leylines|Leyline]]** ([[Nicol Bolas|Bolas]]'s miasma) fused with the **hatreds the party shed** in the Black trial. It wears **each PC's most-hated face** at once. The DM dubbed it the **"Ogre of Bolas"** (instantly iconic, hence the canonical page name; "Ogre of Bolas" is kept as an alias).

## Campaign Role
The cost of victory made flesh. The Black (Hatred) trial of the [[Implicit Maze]] **lifted each PC's core grievance and seeped it into the Leyline** — and because the black Leyline is **poisoned by [[Nicol Bolas|Bolas]]'s miasma** (the same corruption as [[Penny]]'s mark / [[The Second Sun]], rooted in [[Bolas's Citadel]] tapping the lines), those shed hatreds were weaponized back at the party. It attacks while [[Niv-Mizzet]] is still **mid-emergence** (only a claw through the ceiling portal), serving as the gauntlet the party must survive for the revival to complete.

## Description
An amorphous form that **rises from the Leyline moat** behind the party as they cross the Black trial, then fully coalesces at [[Maze's End]]. At resolution it is a roiling figure that **wears every face each PC despises**:
- **[[Nicol Bolas|Bolas]]** for [[Ogre]];
- **school bullies** for [[Rinestra "Rin" Genleth|Rin]] and [[Varis Aestra|Varis]];
- **his parents** ([[Lord Reylana]] / [[Lady Reylana]]) for [[Sanis Reylana|Sanis]];
- **tyrant politicians** for [[Orphea "Orphie" Levistus|Orphie]].

It charges shrieking and hurls a **ball of black energy that bursts into shards** at the party.
...
- **Combat mechanics (this session):**
  ...
  - **Solidified necrotic tendrils** — melee lashes of hardened necrotic energy.
  - **Mist-drag** — pulls PCs into its surrounding mist (cold, dread, **life-draining**); failed Dex saves keep a target trapped.
  - **Max-HP drain** — being held in the mist **permanently reduces maximum HP** for the encounter ([[Orphea "Orphie" Levistus|Orphie]] lost **22 max HP**, down to a **41 max**, until a Greater Restoration).
  - **Energy absorption** — **absorbs fire and psychic damage** ([[Varis Aestra|Varis]]'s Fireball, 4th-level Scorching Ray, and Mind Sliver were all soaked up, black mist billowing off it).
  - **Shadow-echoes** — raises a **shadow-echo from each PC's shadow**, each wearing the face/voice of what that PC hates most: Orphie's **abusive father (pre-reconciliation)**, [[Sanis Reylana|Sanis]]'s **father**, [[Rinestra "Rin" Genleth|Rin]]'s **bully**, [[Varis Aestra|Varis]]'s **masked high-school kidnappers**, and [[Nicol Bolas|Bolas]] himself for [[Ogre]]. ([[Sanis Reylana|Sanis]]'s **Confusion**, DC 18, made the echoes lash out at random.)
  - **Ceiling-shriek** — when its smog was dispelled it **shrieked** (party-wide Con-save force damage) and **shook the chamber's stalactites**, threatening a collapse next round.
...
## Relationships
- [[Nicol Bolas]] — Its corruption-source (the black Leyline is poisoned by his miasma; rooted in [[Bolas's Citadel]]).
- The party — Made of the hatreds they shed in the Black trial; wears each of their most-hated faces.
- [[Niv-Mizzet]] — Attacks while Niv is mid-revival.
