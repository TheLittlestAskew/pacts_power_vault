...
play_date: 04/19/26
title: Hi, I'm Ogre
transcript: "[[19 041926 P&P_transcript]]"
party_level: 12
---
...
> **Numbering:** filed **Session 19 / PP_19**. **This is the penultimate session — the finale is 05/31/26.**
...
> Direct continuation of S18: with the Rotworm tunnel open and the coalition assembled, the party makes the **final push on [[Nicol Bolas\|Bolas]]'s Citadel.** This session is the **penultimate** — it ends mid-climb, on Ogre's apotheosis; the Bolas kill is the **finale (05/31)**.
...
**Party Structure.** A single sustained ascent: Orphie (carrying Rin) + Ogre vanguard; Varis + Sanis behind; later all aboard **Ugin**. **[[Ogre]]** breaks off for his solo apotheosis.
...
**Encounter — Ascending Bolas's Citadel (the assault).**
...
**Full Roll Log (DDB cross-reference).** **78 DDB rolls logged for 2026-04-19**, covering **[[Ogre]], [[Orphea "Orphie" Levistus\|Orphie]], [[Sanis Reylana\|Sanis]], [[Varis Aestra\|Varis]]**. **[[Rinestra "Rin" Genleth\|Rin]] rolled off-DDB** (Divine Intervention d100s — all failed). Selected notable rolls:
