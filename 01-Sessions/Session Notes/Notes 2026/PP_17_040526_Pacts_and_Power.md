...
### A. The Grand Council (surfaced Maze's End)
- **[[Niv-Mizzet]]** (back to **gargantuan** after planeswalking) places a claw on the central die; the ten guild seats channel a **prismatic beacon** to the sky — like Ral's interplanar beacon, but calling **only Ravnica's guild-aligned** forces. Representatives converge: **Gruul** (Sharpdog, Borborygmos), **Boros** (Aurelia, Molly), **Izzet** (Dahlia, in a mech), **Azorius** (Lavinia + sphinxes; Varis's father), **Dimir** (Hikara, Penny, Benji), **Selesnya** (Amara Tandris + **Nissa**, riding the animate **[[Vitu-Ghazi]]**), **Golgari** (**Yarod Votsavo** atop **Steve** the Rotworm), plus Beckett Brass, Lannery Storm, and others. **[[Carl]]** — the Simic crab the party once befriended/doomed — shuffles in as the only Simic present ("if he's here, he's the guild leader").
- **[[Teferi]]** tears open a crack and arrives with a **Zhalfir army** (his recovered home plane), volunteered to aid Ravnica's war.
- All guilds put their energies on the die to **formally unite their forces against [[Nicol Bolas\|Bolas]]**. **Benji gestures [[Sanis Reylana\|Sanis]]** to the **Dimir** die (Sanis carries Lazav, the original Dimir leader, inside him); Sanis does the honors.
- **Niv's directive:** confront Bolas *directly* at his **Citadel** — but the army can't punch through in time, so the party needs **another path in.**

### B. Building the Drill (Dahlia's workshop)
- Two leads converge: **Steve** has been tunneling under Ravnica with Dahlia but can't reach the Citadel — and **Steve's kin (ancient Rotworms) are trapped** in the **Rot Warren** (their spawning grounds) by Bolas's forces. And **Dahlia's "Drillinator"** (Lazotep-plated; core of **lightning + extracted Eternal souls**) needs finishing.
- **The party is wrecked** — **[[Sanis Reylana\|Sanis]] at 3 exhaustion** (failed Leyline grab), Rin at 2, others spent. Dahlia plies them with **caffeine pills** ("work candy, not fun candy") — each removes **1 level of exhaustion**. Endless naps-vs-no-naps comedy.
- **Core stabilization:** the Eternal souls and Ravnican lightning won't mix ("oil and water"); it needs a **surfactant** — reinforced with **"god metal"** (leftover **Tezzeret/hazoretium** the party had given Dahlia). **[[Ogre]] imbues it with Spirits of Death** (his soul/death magic) — it *"feels right,"* and **his magic is what actually harmonizes the souls** with the metal. Orphie hammers it with **Blazebringer** (golf-club swing), Varis Fireballs it. Six combined efforts stabilize the core.
- **Drill bit** smoothed (Orphie hammering, motivated by **Teferi's minor-illusion of "Isaiah's face"** on the bit + Sanis's pep talk).
- The party takes a **full long rest** in Dahlia's lab. (Orphie confirms **level 12 / 125 HP with Toughness**.)
...
|---|---|---|
| **The Drillinator** | Built — Lazotep bit + a **lightning/Eternal-soul core** stabilized with **god metal** (Ogre's soul-magic the key) | [[Dalia Bara]] / party transport |
| **"God metal"** (Tezzeret/hazoretium) | Leftover stock forged into the core's stabilizing plate | Consumed into the drill |
| **Mizzium Gauntlet** | Used by Rin (on loan) to cast Raise Dead — after a Cloudkill misfire | [[Varis Aestra\|Varis]] (lent to Rin) |
| **Bone Staff** (necromancer's) | Re-examined for the *4th time* — still does nothing notable | [[Sanis Reylana\|Sanis]] |
| **Freeze-dried snickerdoodles** | Sanis eats some mid-battle ("die happy") — a few left | [[Sanis Reylana\|Sanis]] |
| **Spell-slot debt** | Rin owes Varis/Orzhov a **5th-level slot** (pact) | Rin → Varis |
...
| [[Sanis Reylana\|Sanis]] | Lightning Arrow (Ava's Longbow) | **48 lightning** | Overcharges & explodes a pylon (+AoE) |
...
| [[Dalia Bara]] | "This is **work candy, not fun candy.**" | Funny |
| [[Orphea "Orphie" Levistus\|Orphie]] (as T-Rex) | "I am a T-Rex **forever**. You can never take this away from me." | Funny / Poignant |
| [[Dalia Bara]] | "Safety is second." / "Sleep's for the dead." | Funny (Izzet ethos) |
