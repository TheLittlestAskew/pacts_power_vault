...
*Detour & descent.* The **Great Tree of [[Vitu-Ghazi]]** fully animates, stomping refugee tents (Boros Angels attack it; Selesnya priests protect their holy tree). The party flies to the **First Church of [[Orzhov Syndicate\|Orzhov]]**, does a dragon-back **drive-by killing ~100 Eternals** to buy [[Lord Aestra]]'s ragtag defense time, then uses the basement portal — **[[Pippi\|Sis]] recalibrates it from Pecunia to the [[Implicit Maze]].** Through it: a vast underground cavern, a **golden labyrinth** streaked gray/purple, ringed by a **moat of raw Leyline energy** (anything that touches it disintegrates — Ogre's test Mage Hand dissolves).

*The five color-trials* (the five primordial colors of magic / guild mana):
1. **Black — Hatred.** A ledger-stone: *"Hatred is the truest ledger of the soul. Speak what you despise most and learn what still owns you."* Each PC names their hatred to raise a stepping-stone (5 total): **Ogre — evil; [[Rinestra "Rin" Genleth\|Rin]] — those who prey on the weak / bullies / the willfully ignorant (and unsafe, protocol-less workplaces); [[Orphea "Orphie" Levistus\|Orphie]] — people who force their will onto others; [[Varis Aestra\|Varis]] — people who hurt others/those who matter (bullies who target the different); [[Sanis Reylana\|Sanis]] — negligent parents who shouldn't have had kids.** Crossing **lifts the hatred from each of them** (it seeps into the Leyline) — and an **amorphous form begins to rise from the moat** behind them.
2. **Red — Haste.** A chasm with three timed stone-buttons → press them (Dex checks) to summon disappearing platforms. After fumbling, three press at once; Orphie **jams hers so hard it sticks** (leftover Rage), locking the platforms. They cross (red Leyline, heat).
3. **White — Order.** Word-buttons; press those that *"bind without breaking"*: **Consent, Balance, Harmony, Structure** (rejecting Control, Obedience, Dominion, Law as "imposed"). Door opens.
4. **Blue — Wits.** Riddle: *"From sea to stone, from stone to gold…"* Orphie's clever **"letter E"** is a *secret/bonus* answer (grants **+5 temp HP**, door stays shut); the true answer — via the color-symbols (jungle/sea/stone/field/bone) — is **magic** (what runs through all the land via the Leylines). Door opens.
5. **Green — Endurance.** A sealed room with a **descending crushing ceiling**; the party must **hold it up** with repeated attacks/effort (Con saves vs **exhaustion** — [[Orphea "Orphie" Levistus\|Orphie]] and [[Rinestra "Rin" Genleth\|Rin]] each take **2 levels of exhaustion**). The green tree-symbol = endurance; they **persevere** and the door unlocks.

*Maze's End — reforging the Guildpact.* A stone ring with **10 guild seats** and a central **pedestal**; the ceiling shows the 5 Leyline colors swirling, with a **barren circle** above the pedestal (it needs a *vessel*). The party places onto the pedestal: the **tattered Guildpact (9 seals)** with **[[Benji]]'s Dimir pin** pinned through it (Rin), plus **[[Jace Beleren\|Jace]]'s old speech/list paper** (Orphie has carried it since Session 1). **[[Ogre]] holds up the [[Black Lotus]]** — which did *nothing* when he tried it before (he wasn't "powerful enough") — and **wishes for a new Guildpact.** This time the **Black Lotus petals unfurl and disintegrate; the wish takes hold.** The **[[Firemind Vessel]]** (holding **[[Niv-Mizzet]]'s soul**, carried by [[Sanis Reylana\|Sanis]]) rises, opens, and forms a **portal in the ceiling** at the Leyline confluence; the colors filter into 10 distinct pairs and beam into each guild seat.

*Reviving Niv-Mizzet.* **[[Ogre]] jumps through the ceiling portal** into darkness and meets **[[Niv-Mizzet]]** (a 6-ft, red-and-blue-haired humanoid form) — who reveals **only Ogre could be here** ("something special about you") and asks Ogre to **pull them back through.** Ogre drags Niv-Mizzet out by the hand — but Niv emerges in **full dragon form** (a massive claw/talon descending through the widening portal). **Niv-Mizzet is being revived.**
...
- **New (boss):** survive the **"[[Ogre of Bolas]]"** hatred-manifestation while Niv finishes emerging.
...
| [[Pippi\|Sis]] | Recalibrated the Orzhov portal to the Implicit Maze | With Ogre |
| [[Lord Aestra]] | Holding the Orzhov front (ragtag); the party bought him time | Defending |
| **[[Niv-Mizzet]]** | Revived via the reforge ritual; met Ogre; being pulled back to life (full dragon) | **Reviving** (mid-emergence) |
...
|---|---|---|
| **Shreds of the First [[Guildpact]]** (9 seals) + **[[Benji]]'s Dimir pin** | Placed on the Maze's End pedestal — the ritual's focus | (On the pedestal) |
| **[[Black Lotus]]** | **Expended** — Ogre's "wish for a new Guildpact" finally worked (he's now "powerful enough"); petals disintegrated | Spent |
| **[[Firemind Vessel]]** (Niv-Mizzet's soul) | Rose to the pedestal, opened the revival portal | Being consumed/transformed (Niv reviving) |
| [[Jace Beleren\|Jace]]'s old paper (his speech/list, from S01) | Added to the pedestal | (On the pedestal) |
| Sanis's Orzhov amulet | Retrieved from Benji | [[Sanis Reylana\|Sanis]] |
...
| [[Varis Aestra\|Varis]] | Force Breath (18d6) | **72** | The Eternal drive-by |
| [[Ogre]]/[[Orphea "Orphie" Levistus\|Orphie]] et al. | Dexterity checks | 8–24 | Red (Haste) platform buttons |
| All | Constitution saves | mixed (Orphie 11/12, Rin 8/8 fails) | Green (Endurance) crushing ceiling → **2 exhaustion each** for Orphie & Rin |
| [[Rinestra "Rin" Genleth\|Rin]] (transcript-only) | Arcana | **30 / 28** | Reading the maze; the Leyline corruption |
...
| [[Sanis Reylana\|Sanis]] / [[Varis Aestra\|Varis]] | "Look who I found." / "It always pays to jump through a portal." | Funny |
...
- **Ogre is plot-special** (only he could reach Niv) — watch this thread.
