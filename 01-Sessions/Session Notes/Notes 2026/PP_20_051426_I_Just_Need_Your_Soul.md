...
I had Liliana the whole time. From the second the fight started I got my arms around her and I didn't let go — dragged her dead weight across that black stone toward the others while Blazebringer bit into her again and again, and she never so much as looked at me. She was somewhere else, eyes rolled white, hands twitching those god-puppets on their strings. So I just kept hauling her to where Ogre could reach, because if my new god-of-death friend says he needs a soul, who am I to argue. And then he cracked her loose of the thing, and the woman underneath wasn't a monster at all — just somebody who got cornered into a bad contract and didn't want to die for it.
...
- **[[Orphea "Orphie" Levistus\|Orphie]] grapples & drags Liliana** (reconstructed — see §6): she keeps Liliana **grappled** the entire fight, **dragging her ~20 ft** toward the party while clubbing her with **Blazebringer** (to-hit 27, 18). Liliana — "in the zone," eyes white — never reacts.
- **[[Ogre]] breaks the control.** Now **Ur-Ogre-lan** (the halfling death-god made whole), Ogre **Misty Steps** to Liliana and tries to **siphon her soul** with **Duskblade** (15 psychic, then a 31-to-hit for 27). The damage **shatters the Chain Veil's grip** — Liliana's pupils **snap back into focus**, she goes lucid, drops her arms, and the God-Eternals **freeze.**
- **The reveal — Liliana is a reluctant pawn.** Freed enough to speak, she explains: Bolas's last command was to **defend the platform**; she's **contractually bound** and **will die** if she turns on him. *"I don't want to do evil, but contractually I have to."* (She's been, in effect, helping them — a good person trapped by a contract.)
- **The rewrite ("Pacts and Power" again).** **[[Varis Aestra\|Varis]], as the [[Orzhov Syndicate\|Orzhov]] Guildmaster, rewrites her contract** (Arcana 27): he **erases both the demon contract and Bolas's overlay** and transfers the binding to **[[Rinestra "Rin" Genleth\|Rin]]** — Liliana now serves **Rin/Ravnica until Rin releases her**, with strong protections (Taylor drafted an elaborate, AI-assisted contract barring her from being used "as a vessel, weapon, sacrifice, or bargaining token without consent" — the table loved it). Varis seals it by burning the old contracts away in **white-and-black Orzhov flame.**
...
| Molly | Duels God-Eternal **Bontu**; bloodied, then healed | Alive, fighting for Ravnica |
...
|---|---|---|
| **The Chain Veil** | Demon-contract artifact — **contract rewritten** (demon + Bolas overlays erased; bound to Rin/Ravnica) | [[Liliana Vess]] (controlled by [[Rinestra "Rin" Genleth\|Rin]]) |
| **The spark-orb** | Bolas's siphoning fuel; **slowly shrinking** as he absorbs it | Above the Citadel (Bolas) |
| **Blazebringer** | Orphie's axe — grappling/dragging/clubbing Liliana | [[Orphea "Orphie" Levistus\|Orphie]] |
...
**Reconstructing Orphie (no audio — from her DDB roll log + DM narration).** Roll clock-times map to the transcript (initiative 20:47 = transcript 00:10; her Blazebringer hits 21:26–21:28 = transcript ~00:47–00:50):

| Clock | Roll | Reconstructed action |
|---|---|---|
| 20:47 | Initiative (adv) → **18** | Rolls into the fight |
| ~21:26 | Blazebringer to hit (adv) **27** [17,8] → **16 dmg** + tattoo | **Grapples & drags Liliana** ~20 ft toward the party, clubbing her |
| ~21:28 | Blazebringer to hit (adv) **18** [8,6] → **12 dmg** + tattoo | Second strike; Liliana (in the Veil's "zone") doesn't react |
| (later) | *(retroactive Rage; sustained grapple)* | Keeps Liliana **fully grappled** through the entire contract scene |
| 22:14 | d20 **18** (+Perc ≈ 22) | **Perception check** — confirms the God-Eternals froze when Liliana broke free |
...
|---|---|---|---|
| [[Sanis Reylana\|Sanis]] | Ava's Longbow + **Lightning Arrow** | to-hit 25; **31 dmg + Slow** | Hits Bontu's jaw-screws (after testing his regular bow first — rage-baiting Ogre) |
| [[Sanis Reylana\|Sanis]] | Ava's Longbow to hit | **nat 20 (29)** | Crit on Bontu (double dice — 30 dmg) |
| [[Ogre]] | Duskblade to hit | **31** [15] → **27 dmg** | Siphoning Liliana's soul — breaks the Chain Veil's control |
| [[Ogre]] | Eldritch Blast (×3) / Mage Hand | 20 hit; pulls Bontu 10 ft | Dragging the god off Molly |
| [[Ogre]] | Wisdom save vs. Bontu's scream | **22** [15] | (Varis failed his — nat 1) |
| [[Varis Aestra\|Varis]] | Raulothim's Psychic Lance (quickened) | **19 psychic + incapacitate** | Freezes Bontu mid-attack on Sanis |
| [[Varis Aestra\|Varis]] | Arcana (contract rewrite) | **27** | Overwrites the Chain Veil contract → Rin |
