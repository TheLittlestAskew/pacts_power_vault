...
> Working from the **raw** transcript (no separate "-Corrected" version). No spell-check pass (per Taylor). Title **"Hi, I'm Ogre"** confirmed by Taylor — the chaos-goblin mascot's deadpan return after being revealed as the halfling god of death made whole.
> **Numbering:** filed **Session 18 / PP_18**. **This is the penultimate session — the finale is 05/31/26.**
> ⚠️ **Speaker labels unreliable** (Ogre's lines often folded into "DM"; PC swaps). Attribution reconciled against the **DDB roll log** + class kits.
...
|---|---|
| Session # | 18 |
| Real-world play date | 04/19/26 |
| Party level | **12** |
| In-game location | The **Rot Warren** → **Maze's End** (regroup) → up the tunnel to **[[Nicol Bolas\|Bolas]]'s Citadel** (the 400-ft black pyramid) |
| Present (PCs) | [[Orphea "Orphie" Levistus\|Orphie]], [[Ogre]], [[Rinestra "Rin" Genleth\|Rin]], [[Sanis Reylana\|Sanis]], [[Varis Aestra\|Varis]] |
| Allies summoned | **Penny**, **Molly**, **Nissa Revane** (+ [[Niv-Mizzet]], [[Dalia Bara]], Steve/[[Yarok\|Yarod Votsavo]], the myconids, Boros, Rakdos) |
| Antagonists | **[[Nicol Bolas]]** (siphoning the harvested sparks), **[[Liliana Vess]]** (Chain Veil, marionetting the God-Eternals), **God-Eternals** Bontu/Ronas/+1 (Oketra already downed) |
| DDB rolls | **78 logged on 2026-04-19** — covering **[[Ogre]], [[Orphea "Orphie" Levistus\|Orphie]], [[Sanis Reylana\|Sanis]], [[Varis Aestra\|Varis]]**. **[[Rinestra "Rin" Genleth\|Rin]] rolled physically/off-DDB** (her Divine Intervention d100s). |

## Section 2 — Orphie's POV Overview

We climbed a mountain made of a dead god's spite to get to the worst dragon in the world, and the whole way up I kept thinking about the road that brought us here — detention at Tenth Street, the tavern, every friend we made and buried. We're so close now I can taste it. Bolas just sat up there on his throne drinking down everybody's stolen souls like it was nothing, untouchable while he fed, and Liliana danced her puppet-gods on their strings, and we threw Eternals off the steps and dodged arrows the size of trees and I carried Rin on my back while she begged her goddess for a hand that never came. We're not done. He's still up there. But we made the top.

And then Ogre — our chaos goblin, our mascot, the one who runs face-first into walls — fell into that ball of stolen light on purpose, and he didn't die. He went home, to a forest and a father and a basket of mushrooms, and then somewhere older than that, and he came back with a beard and quiet eyes and the whole truth behind them: he was never just Ogre. He's the heart of a death god, cut loose to go live and love and eat mushrooms among us, and now he's whole again. He stood next to Varis, gave that little wise smile, and said "Hi, I'm Ogre," and I swear something in the air shifted. Tomorrow — next time — we end this. But tonight we found out what our friend really is.

## Section 3 — Session Analysis

> Direct continuation of S17: with the Rotworm tunnel open and the coalition assembled, the party makes the **final push on [[Nicol Bolas\|Bolas]]'s Citadel.** This session is the **penultimate** — it ends mid-climb, on Ogre's apotheosis; the Bolas kill is the **finale (05/31)**.
...
- **[[Niv-Mizzet]] bursts out as a distraction**, joining a chaotic battlefield: **Golgari Rotworms** swallowing Eternals, **Izzet mech-suit scientists**, **myconid spore-clouds** paralyzing Eternals, **Rakdos** strafing from the sky, **[[Dalia Bara]] + myconids** holding the tunnel-mouth beachhead.
...
|---|---|---|
| **The ball of harvested sparks** | Powers/shields Bolas as he siphons it; **Ogre plunged into it** (absorbed → triggered his apotheosis) | Atop the Citadel (Bolas) |
| **The Chain Veil** | Liliana's mask — lets her marionette the God-Eternals | [[Liliana Vess]] |
| **Dusk** (Ogre's blade) | The conduit Ogre drove into the spark-ball | [[Ogre]] |
| **Blazebringer** | Orphie's axe (used to throw/strike Eternals & Liliana) | [[Orphea "Orphie" Levistus\|Orphie]] |
| **Ava's Longbow of Power** | Sanis's Lightning-Arrow support fire | [[Sanis Reylana\|Sanis]] |

*No loot — the "gain" is positional (the summit) and narrative (Ogre's godhood).*

## Section 6 — Logs

### Encounters

**Ascending Bolas's Citadel (the assault)**
- **Party:** all five + Ugin (summoned) + allied beachhead (Niv, Dalia, myconids, Rotworms, Boros/Molly, Rakdos).
- **Enemies:** **squads of Eternals** patrolling the steps; **God-Eternals** (Bontu/Ronas/+1) raining arrows from above (Liliana's puppets); **[[Liliana Vess]]**; **[[Nicol Bolas]]** (siphoning — invulnerable this session).
- **Key beats:** planeswalk-regroup; Pass-Without-a-Trace climb; Eternals thrown off the steps; Sanis's **nat-1** (27 piercing); summon **Ugin** to fly up; Varis's **nat-20 Scorching Ray** on Bolas (dissipates); **Ogre's spark-plunge → apotheosis.**
- **Outcome:** 🔶 **Summit breached; Ogre made a god.** Bolas/Liliana/God-Eternals **still standing** — *continues into the finale.*

### Full Roll Log

**78 DDB rolls logged for 2026-04-19**, covering **[[Ogre]], [[Orphea "Orphie" Levistus\|Orphie]], [[Sanis Reylana\|Sanis]], [[Varis Aestra\|Varis]]**. **[[Rinestra "Rin" Genleth\|Rin]] rolled off-DDB** (Divine Intervention d100s — all failed). Selected notable rolls:
...
| [[Varis Aestra\|Varis]] | Scorching Ray to hit (1d20+10) | **30** [nat 20] / 29 | Direct hit on Bolas — **dissipates** (he's siphoning) |
| [[Varis Aestra\|Varis]] | Arcana (1d20+8) | **30** / 23 | Reading the meditation realm / the spark-shielded Bolas |
| [[Sanis Reylana\|Sanis]] | Lightning Arrow (Ava's Longbow) | **23 + 14** | Support fire on Bontu (Molly takes splash) |
| [[Sanis Reylana\|Sanis]] | Dexterity save (1d20+7) | **8** [nat 1] | Ronas's arrow → 27 piercing |
| [[Orphea "Orphie" Levistus\|Orphie]] | Blazebringer to hit (1d20+10) | 25 / 26 / 23 | Throwing Eternals off the steps; striking Liliana |
